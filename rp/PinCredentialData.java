...
public class PinCredentialData {
     ...
     */
    public PinCredentialData(int hashIterations, String algorithm) {
     ...
     */
    @JsonCreator
    public PinCredentialData(@JsonProperty("hashIterations") int hashIterations, @JsonProperty("algorithm") String algorithm, @JsonProperty("algorithmData") Map<String, List<String>> additionalParameters) {
