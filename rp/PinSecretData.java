...
public class PinSecretData {
    ...
    public static final Logger logger = Logger.getLogger(PinSecretData.class);
     ...
     */
    @JsonCreator
    public PinSecretData(@JsonProperty("value") String value, @JsonProperty("salt") String salt, @JsonProperty("algorithmData") Map<String, List<String>> additionalParameters) throws IOException {
     ...
     * @param salt salt
     */
    public PinSecretData(String value, byte[] salt) {
        this.value = value;
        this.salt = salt;
